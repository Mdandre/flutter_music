...
class _MyAppState extends State<MyApp> {
  var player = Player.network("https://archive.org/download/s0v5kiwcwp1zaps7pdwjtp5o8e6clmevdnewngnd/JSJ_385_Panel.mp3", autoPlay: false);
  @override
  void initState() {
    super.initState();
  }
                    ...
                    child: StreamBuilder(
                      ...
                      builder: (context, snapshot) {
                        return CircularProgressIndicator(
                          strokeWidth: 1,
                          color: Colors.teal,
                          value: loading ? null : player.position.inSeconds / max(player.duration.inSeconds, 0.01),
                        );
                      },
                    ),
                  ),
                    ...
                    builder: (context, AsyncSnapshot<Duration> snapshot) {
                      ...
                      return CupertinoSlider(
                        ...
                        onChanged: (double value) {
                          setState(() {
                            loading = true;
                            _position = Duration(seconds: ((value / 100) * player.duration.inSeconds).toInt());
