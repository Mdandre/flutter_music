...
import 'package:flutter_music/extensions/duration_extensions.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        backgroundColor: Color.fromARGB(255, 75, 6, 84),
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // GestureDetector(
                    //   onTap: () async {
                    //     if (await canLaunch("https://github.com/vellt")) await launch("https://github.com/vellt");
                    //   },
                    //   child: Text(
                    //     "GitHub/vellt",
                    //     style: TextStyle(
              ...
              //                   color: (playerController.currentStreamIndex.value == index) ? Color(0xFF2A2A2A) : Colors.transparent,
              //                   borderRadius: BorderRadius.all(
              //                     Radius.circular(10.sp),
              //                   ),
              //                 ),
              ...
              Container(
                decoration: BoxDecoration(
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                      color: Color.fromARGB(255, 119, 13, 94),
                      blurRadius: 15.sp,
                      offset: Offset(0, 0),
                      spreadRadius: 30.sp,
                    ),
                ...
                child: Obx(
                  () => Column(
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(right: 10.sp, left: 10.sp, top: 5.sp, bottom: 16.sp),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            IconButton(
                            ...
                            IconButton(
                              ...
                              iconSize: 60.sp,
                              icon: Icon(
                                (playerController.playState.value == PlayerState.playing) ? Icons.pause : Icons.play_arrow,
                                color: Colors.white,
                              ),
                            ),
                            IconButton(
